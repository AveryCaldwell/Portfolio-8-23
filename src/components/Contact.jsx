...
function Contact({ props }) {
	...
	return (
		<>
			<div
				classNameName="contactContainer pageContainer"
			...
			>
				...
				>
					<h1 classNameName="contactTitle" style={contactTitle}>
						LET'S CHAT!
					</h1>
					{/* <!-------------- Name drawing ------------------> */}
						...
						<form method="post" classNameName="form" id="form1">
							...
							<p classNameName="name">
								...
								<input
									...
									name="name"
									type="text"
									classNameName="validate[required,custom[onlyLetter],length[0,100]] feedback-input"
									placeholder="Name"
									id="name"
								/>
							</p>
							<p classNameName="email">
								...
								<input
									...
									name="email"
									type="text"
									classNameName="validate[required,custom[email]] feedback-input"
									id="email"
									placeholder="Email"
								/>
							</p>
							<p classNameName="formText">
								...
								<textarea
									...
									name="text"
									classNameName="validate[required,length[6,300]] feedback-input"
									id="comment"
									placeholder="Comment"
								></textarea>
							</p>
							<div classNameName="submit">
								<input
									...
									id="button-blue"
								/>
								<div classNameName="ease" style={ease}></div>
							</div>
						</form>
					</div>
					{/* <!-- form-div  --> */}
