        ...
        <div className='refBox' style={refBox}>
          <div
            ...
            <div className='card first' style={card}>
              <div className='additional first' style={additional}>
                  ...
                  <svg
                    ...
                    <g stroke='none' strokeWidth='0' clipPath='url(#scene)'>
                      ...
                      <g id='shirt'>
                        ...
                        />
                        <circle cx='125' cy='188' r='4' fill='#003262' />
                        <circle cx='125' cy='202' r='4' fill='#003262' />
                        <circle cx='125' cy='216' r='4' fill='#003262' />
                        <circle cx='125' cy='230' r='4' fill='#003262' />
                        <circle cx='125' cy='244' r='4' fill='#003262' />
                        <path
                          stroke='#daa37f'
                          strokeWidth='1'
                          className='skin hand'
                ...
                <div className='more-info' style={moreInfo}>
                  ...
                  <div className='coords' style={coords}>
                    ...
                    <span style={coordsSpan}>Joined 2015</span>
                  </div>
                  <div className='coords' style={coords}>
                    <span style={coordsSpan}>Software Architect</span>
                    <span style={coordsSpan}>Seattle, WA</span>
                  </div>
                  <div className='stats' style={stats}>
                    <div>
                      <div className='title' style={statsTitle}>
                        Patents
                      </div>
                      <i className='fa fa-trophy' style={statsTrophy}></i>
              ...
              <div className='general' style={general}>
                ...
                <p>
                  Specialized in VR applications, photogrammetry, and
                  manipulations of scientific photographic equipment in an
            ...
            <div class='card second' style={card}>
              <div
                    ...
                    <g stroke='none' strokeWidth='0' clipPath='url(#scene)'>
                      ...
                      <g id='shirt'>
                        ...
                        <path
                          ...
                          d='M 133,166 C 133,166 125,172 125,172 125,182 135,182 141,170 Z'
                        />
                        <circle cx='125' cy='188' r='4' fill='#7C0902' />
                        <circle cx='125' cy='202' r='4' fill='#7C0902' />
                        <circle cx='125' cy='216' r='4' fill='#7C0902' />
                        <circle cx='125' cy='230' r='4' fill='#7C0902' />
                        <circle cx='125' cy='244' r='4' fill='#7C0902' />
                        <path
                          stroke='#daa37f'
                          strokeWidth='1'
                          className='skin hand'
                ...
                <div className='more-info' style={moreInfo}>
                  ...
                  <div className='coords' style={{ color: "#325c46" }}>
              ...
              <div className='general' style={general}>
                ...
                <p>
                  Principal Software Engineer with over 20 years of experience
                  working across multiple development technologies and
                  platforms.
                </p>
                <span className='more' style={more}>
                  Mouse over the card for more info
            ...
            <div class='card third' style={card}>
              <div
                    ...
                    <g stroke='none' strokeWidth='0' clipPath='url(#scene)'>
                      ...
                      <g id='shirt'>
                        ...
                        <path
                          ...
                          d='M 133,166 C 133,166 125,172 125,172 125,182 135,182 141,170 Z'
                        />
                        <circle cx='125' cy='188' r='4' fill='#1E4D2B' />
                        <circle cx='125' cy='202' r='4' fill='#1E4D2B' />
                        <circle cx='125' cy='216' r='4' fill='#1E4D2B' />
                        <circle cx='125' cy='230' r='4' fill='#1E4D2B' />
                        <circle cx='125' cy='244' r='4' fill='#1E4D2B' />
                        <path
                          stroke='#daa37f'
                          strokeWidth='1'
                          className='skin hand'
                ...
                <div className='more-info' style={moreInfo}>
                  <h1 style={{ color: "#224c36" }}>Alexa Zylstra</h1>
                  <div className='coords' style={{ color: "#325c46" }}>
                  ...
                  <div className='coords' style={coords}>
                    ...
                    <span style={coordsSpan}>Nashville, TN</span>
                  </div>
                  <div
                    className='stats'
                    style={{ color: "white", flex: "1", textAlign: "center" }}>
